            ...
            <div class="form-section">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group full-width">
                        ...
                        <input type="text" id="address" name="address" value="{{ old('address', $hotel->address) }}" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="district" name="district" value="{{ old('district', $hotel->district) }}" required>
                    </div>
            ...
            <div class="form-section">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="phone" name="phone" value="{{ old('phone',$hotel->phone) }}" required>
                    </div>

                    <div class="form-group">
                        <label for="email">Email</label>
                        <input type="email" id="email" name="email" value="{{ old('email',$hotel->email) }}" required>
                    </div>
            ...
            <div class="form-section">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="time" id="checkin_time" name="checkin_time" value="{{ old('checkin_time', $hotel->checkin_time) }}"
                            required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="time" id="check_out_time" name="check_out_time"
                            value="{{ old('check_out_time', $hotel->check_out_time) }}" required>
                    </div>
